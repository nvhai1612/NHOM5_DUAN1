...
public class HDCTRepos implements IHDCTRepos {
    ...
    public ArrayList<HoaDonDTO> getListFormDB() {
        ...
        try (Connection con = connection.getConnection();
                PreparedStatement ps = con.prepareStatement("SELECT MAHD, TENNV, TENKH, kh.SDT, kh.DIACHI, TRANGTHAIHD,hd.NGAYTAO,TONGTIEN,hd.LYDOHUY FROM HOADON hd  LEFT JOIN KHACHHANG kh ON kh.ID = hd.IDKH LEFT JOIN NHANVIEN nv ON nv.ID = hd.IDNV ")) {
            ...
            while (rs.next()) {
                ...
                hddto.setDonGia(rs.getInt("TONGTIEN"));
